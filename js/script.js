...
function agregar(){
	...
	var elementoCotenedor = document.createElement("span");

	elementoCotenedor.appendChild(textoNuevaTarea);
	nuevasTareas.appendChild(elementoCotenedor);
	...
	chck.addEventListener("click", function(){
		elementoCotenedor.classList.toggle("tachado");
	})
